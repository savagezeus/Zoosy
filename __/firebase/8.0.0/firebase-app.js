! function(e, t) {
    ...
    var a, s, l, c = "FirebaseError",
        p = (a = Error,
            r(s = v, l = a),
            s.prototype = null === l ? Object.create(l) : (f.prototype = l.prototype,
                new f),
            v);
    ...
    var L = "[DEFAULT]",
        S = (R.prototype.get = function(e) {
            ...
            R.prototype.getOrInitializeService = function(e) {
                ...
                return !r && this.component && (r = this.component.instanceFactory(this.container, (t = e) === L ? void 0 : t),
    ...
    var V = ((V = {})["no-app"] = "No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()",
    ...
    function Z(l) {
            ...
            p = {
                ...
                registerVersion: function(e, t, r) {
                    ...
                    if (i || e) {
                        ...
                        return i && r.push('library name "' + n + '" contains illegal characters (whitespace or "/")'),
                            i && e && r.push("and"),
        ...
        function o(r) {
            var t, e, n, i = r.name;
            if (u.has(i))
                return $.debug("There were multiple attempts to register component " + i + "."),
    ...
    return re.registerVersion("firebase", "8.0.0", "app"),
        re
});
